...
#include <EMAI/hardware/ICameraService.h>
...
status_t CameraStatus::readFromParcel(const EMAI::Parcel* parcel) {
...
namespace {
    sp<::EMAI::hardware::ICameraService> gCameraService;
...
int CameraBase<TCam, TCamTraits>::getNumberOfCameras() {
    ...
    binder::Status res = cs->getNumberOfCameras(
            ::EMAI::hardware::ICameraService::CAMERA_TYPE_BACKWARD_COMPATIBLE,
            &count);
    if (!res.isOk()) {
...
status_t CameraBase<TCam, TCamTraits>::getCameraInfo(int cameraId,
    ...
    const sp<::EMAI::hardware::ICameraService> cs = getCameraService();
