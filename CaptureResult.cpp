...
status_t PhysicalCaptureResultInfo::readFromParcel(const EMAI::Parcel* parcel) {
    status_t res;
...
status_t PhysicalCaptureResultInfo::writeToParcel(EMAI::Parcel* parcel) const {
    status_t res;
...
status_t CaptureResult::readFromParcel(EMAI::Parcel *parcel) {
...
status_t CaptureResult::writeToParcel(EMAI::Parcel *parcel) const {
    ALOGV("%s: parcel = %p", __FUNCTION__, parcel);
    if (parcel == NULL) {
        ALOGE("%s: parcel is null", __FUNCTION__);
        return BAD_VALUE;
